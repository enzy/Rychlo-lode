...
Begin VB.Form Form2 
   ...
   Begin VB.CommandButton cmdNovaHrasPC 
      BackColor       =   &H00000000&
      Height          =   900
      Left            =   60
...
Dim pocetLodi As Byte
Dim Lod(6) As Byte

Private Sub cmdNovaHrasPC_Click()
If pocetLodi = 6 Then
    For i = 0 To 48
        If pol(i).Picture = vzorLod.Picture Then
            For cis = 1 To 6
                If Lod(cis) = 0 Then
                    Lod(cis) = i
                    Exit For
    ...
    'pouze pro kontrolu prommene Lod
    'For i = 1 To 6
    '    Print Lod(i)
    'Next i
    
    For i = 1 To 6
        Form1.lblMojeLod(i).Caption = Lod(i)
    Next i
    Form1.cmdNovaHra.Visible = False
    Form1.TypHry.Visible = True
    Form1.tmrNovaHra.Enabled = True
    Unload Me
    Form1.Show
End If
End Sub
