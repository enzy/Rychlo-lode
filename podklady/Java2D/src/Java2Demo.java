...
public class Java2Demo extends JPanel implements ItemListener, ActionListener
{
    ...
    public Java2Demo() {
        ...
        // hard coding 13 = 11 demo dirs + images + Intro
        ...
        if (e.getSource().equals(controlsCB)) {
            ...
            if (tabbedPane.getSelectedIndex() != 0) {
                ...
                for (int i = 0; i < p.getComponentCount(); i++) {
                    ...
                    if (dp.custom != null) {
                        dp.custom.customControlsThread(state);
                    }
                } 
            }
        }
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i].startsWith("-h") || args[i].startsWith("-help")) {
                ...
                s = "    -runs=5       Number of runs to execute\n" +
                    ...
                    "    -verbose      output DemoSurface graphic states \n" +
                    "    -print        during run print the DemoSurface, " +
