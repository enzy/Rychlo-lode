...
/**
 * Obsluha prubehu cele hry, jframe GUI
 * @author Enzy
 */
public class hlavniokno extends javax.swing.JFrame {
    ...
    static public String highscore = "Nej hra";
	 static public jframeTop20 jfhighscore = null;
    /**
   ...
   private void initComponents() {
      ...
      jButton_nejcas.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(java.awt.event.ActionEvent evt) {
            jButton_nejcasActionPerformed(evt);
         }
      });
    ...
    private void jButton_nahranihry(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_nahranihry
	 ...
	 private void jButton_nejcasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_nejcasActionPerformed
		UkazHighscore();
	 }//GEN-LAST:event_jButton_nejcasActionPerformed

	 /**
	  * Ukaz okno s highscore
	  */
	 private void UkazHighscore(){
		 if(jfhighscore == null) jfhighscore = new jframeTop20();
		 else jfhighscore.setVisible(true);
	 }
